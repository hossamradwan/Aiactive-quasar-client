...
export default {
  ...
  methods: {
    ...
    ...mapActions('averageSpeedResult', ['getAverageSpeedResults', 'getAverageSpeedDistinctDates',
                  'setAverageSpeedPagination',
                  'setUpdateAverageSpeedTransits', 'updateAverageSpeedResults',
                  'setDeviceFilter']),
  ...
  computed: {
    ...mapState("averageSpeedResult", ['pagination', 'filters', 'updateTransits', 'lprDataDownloaded']),
    ...mapGetters("averageSpeedResult", ['paginationData', 'sortedTransits', 'updateAverageSpeedTransits']),
