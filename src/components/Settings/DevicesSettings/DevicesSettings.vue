<template>
  <div class="q-pa-md">
    ...
    <q-dialog
      ...
      <add-device
        @close="addDeviceModal=false" />
    </q-dialog>

    <!-- Edit User Modal -->
    <q-dialog
      v-model="editDeviceModal"
      @hide="closeEditDevice" >
      <edit-device
...
export default {
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'deviceType', align: 'center', label: 'Type', field: 'deviceType', sortable: true },
        { name: 'deviceZone', align: 'center', label: 'Zone', field: 'deviceZone' },
  ...
  components: {
    'add-device': require('components/Settings/DevicesSettings/Modals/AddDevice').default,
    'edit-device': require('components/Settings/DevicesSettings/Modals/EditDevice').default
  },


  methods: {
    ...mapActions('devices', ['getDevices', 'deleteDevice', 'setAddDeviceModal', 'setEditDeviceModal']),
    editDevice(deviceId) {
